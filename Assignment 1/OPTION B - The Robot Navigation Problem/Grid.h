...
class Grid
{
    ...
    */
    ...
    /*
     Helper function to check whether a cell exist 
     or is not a wall
     or can be relaxed for dijkstra's algorithm
     @param x x-coordinate / row number
     @param y y-coordinate / column number
     @return true if cell is valid false otherwise
    */
    ...
    */
    ...
    @param src source node
    @param dest destination node
    Disadvantages: Smallest cost value may not be efficient every time.
    ...
    */
    ...
    Expands all it's neighbour then moves onto their neighbour
